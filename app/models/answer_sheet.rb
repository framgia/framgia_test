class AnswerSheet < ActiveRecord::Base
  ...
  has_many :answer_sheet_details, foreign_key: "answer_sheet_id", class_name: "AnswerSheetDetail", dependent: :destroy, :conditions => "training_answer_sheet_detail.active_flag = 1"
